...
public class Main {
    public static void main(String[] args) {
        ...
        //вывод
        //System.out.println(test1); //NullPointerException
        System.out.println(test2); //false
        //System.out.println(test3); //NullPointerException
        //System.out.println(test4); //NullPointerException
        //System.out.println(test5); //NullPointerException
